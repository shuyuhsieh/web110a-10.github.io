...
public class ImageService
    {
        ...
        public static string ImageFolder { get; set; } = "~/img";
        public static string ImageSubFolder { get; set; } = "product";
        ...
        public static void ProductUploadimage(HttpPostedFileBase file)
        {
            if (file != null)
            {
